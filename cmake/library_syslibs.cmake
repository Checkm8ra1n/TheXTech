...
if(APPLE)
    ...
    # macOS-only frameworks, not available on iOS
    if(NOT PLATFORM STREQUAL "OS64" AND NOT PLATFORM STREQUAL "OS" AND NOT PLATFORM STREQUAL "SIMULATOR64" AND NOT PLATFORM STREQUAL "SIMULATORARM64")
        ...
        xtech_add_macos_library(CoreText)
        xtech_add_macos_library(CoreServices)
        xtech_add_macos_library(Security)
        xtech_add_macos_library(MobileCoreServices)
    endif()
endif()
